...
class _OrderState extends State<Order> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: EdgeInsets.only(top: 12.h, left: 8.w, right: 8.w, bottom: 2.h),
      height: 180.h,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color:
                              Color.fromARGB(255, 45, 44, 44).withOpacity(0.2),
                          spreadRadius: 0.4,
                          blurRadius: 2,
                          offset: Offset(0, 2),
                        ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: Color.fromARGB(255, 49, 49, 49).withOpacity(0.2),
                        spreadRadius: 0.4,
                        blurRadius: 1,
                        offset: Offset(0, 2),
                      ),
