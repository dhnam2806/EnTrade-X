...
class StockData {
  ...
  static List<Stock> data1 = [
    Stock(name: "VNF2", price: 1231, changePercent: 0.15, total: 52470),
    Stock(name: "VNF1", price: 1232, changePercent: -0.5, total: 26100),
    Stock(name: "VNF2", price: 1228, changePercent: -2, total: 6730),
    Stock(name: "VNF0", price: 1225, changePercent: 10, total: 1000),
  ];

  static List<Stock> data2 = [
